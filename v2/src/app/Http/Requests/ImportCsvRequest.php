...
class ImportCsvRequest extends FormRequest
{
    ...
    {
        return [
            'file'        => 'required_without:csv_content|nullable|file|mimes:csv,txt',
    ...
    {
        return [
            'file.required_without'        => 'Envie um arquivo CSV ou cole o conteúdo na caixa de texto.',
            'file.file'                    => 'O arquivo enviado é inválido.',
            'file.mimes'                   => 'O arquivo deve ser do tipo CSV ou TXT.',
            'csv_content.required_without' => 'Cole o conteúdo CSV ou envie um arquivo.',
